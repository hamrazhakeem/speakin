	...
	const benefits = [
		{
			...
			description:
				"Connect with fellow educators and share teaching experiences in our vibrant community",
		},
		{
			icon: Calendar,
			title: "Flexible Schedule",
			description:
				"Design your teaching schedule around your lifestyle with our easy-to-use platform",
		},
		{
			icon: Award,
			title: "Professional Growth",
			description:
				"Access exclusive teaching resources and development opportunities",
		},
	];
			...
			<section className="py-12 bg-gradient-to-br from-blue-600 to-indigo-600 relative overflow-hidden">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
					...
					<p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
						Join our community of expert tutors and start impacting lives
						globally
					</p>
					<div className="flex flex-col sm:flex-row gap-4 justify-center">
						<LandingButton
