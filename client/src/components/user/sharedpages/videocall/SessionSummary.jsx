    ...
    useEffect(() => {
      ...
      const fetchSessionDetails = async () => {
        try {
          ...
          const availabilityResponse = await axiosInstance.get(`tutor-availabilities/${bookingResponse.data.availability}/`);
                ...
                <div className="bg-gray-50 rounded-xl p-4 flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Duration: {sessionDetails.session_type === 'standard' ? '60' : '20'} minutes
                    </p>
                  </div>
                </div>
