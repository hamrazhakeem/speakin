...
const ProfilePicture = ({
	...
	return (
		<div
			className={`bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg transition-shadow duration-200 ${className}`}
		>
			...
			<div className="flex flex-col items-center gap-4">
				...
				{editMode && isTutor && (
					<p className="text-sm text-gray-600 text-center">
						To maintain the professionalism of the platform, we recommend upload
						the image when request for language change.
					</p>
				)}
				...
				{!isTutor && (
					<div className="w-full mt-4 space-y-3">
						<PrimaryButton onClick={() => navigate("/withdraw")}>
							Withdraw Credits
						</PrimaryButton>
					</div>
				)}
