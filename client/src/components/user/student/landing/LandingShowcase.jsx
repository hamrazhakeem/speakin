	...
	const benefits = [
		{
			...
			description:
				"Learn from tutors verified with government ID for authentic language experience",
		},
		{
			icon: Video,
			title: "1-on-1 Video Sessions",
			description:
				"Personalized video lessons tailored to your learning goals and schedule",
		},
		{
			icon: MessageCircle,
			title: "Chat with Tutors",
			description:
				"Direct messaging with tutors for questions, scheduling, and learning support",
		},
	];
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col items-center text-center">
						...
						<p className="text-xl text-gray-600 max-w-2xl mb-12">
							Connect with verified native speakers and certified language
							tutors for personalized 1-on-1 video lessons. Learn at your own
							pace, anytime.
						</p>
						...
						<div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
							...
							<LandingButton onClick={() => navigate("/tutor")} variant="white">
								Become a Tutor
							</LandingButton>
						</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16 space-y-4">
						...
						<p className="text-gray-600 max-w-2xl mx-auto text-lg">
							Experience the most effective way to learn a new language with our
							unique features
						</p>
					</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16 space-y-4">
						...
						<p className="text-gray-600 text-lg">
							Join our community of 25,000+ language learners worldwide
						</p>
					</div>
				...
				<div className="container mx-auto px-4">
					...
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<p className="text-lg text-gray-600">
							Experience seamless and secure transactions powered by our
							strategic partnership with Stripe's global payment infrastructure
						</p>
					</div>
			...
			<section className="py-12 bg-gradient-to-br from-blue-600 to-indigo-600 relative overflow-hidden">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
					...
					<p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
						Share your language expertise and earn money by becoming a tutor on
						our platform
					</p>
					<LandingButton onClick={() => navigate("/tutor")} variant="white">
						Become a Tutor
