...
const AdminSignInPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-blue-100">
      <div className={`w-full max-w-md bg-white p-8 shadow-lg rounded-lg transform transition-transform duration-700 ease-out ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <div className="mb-6 text-center">
          <img 
            src="/src/assets/logo.webp" 
            alt="Admin Logo"
            className={`mx-auto w-40 h-24 object-contain animate-pulse ${animate ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
          />
        </div>
        <h1 className="text-2xl md:text-3xl font-bold mb-4 text-center text-blue-500 font-sans">SpeakIn Admin</h1>
