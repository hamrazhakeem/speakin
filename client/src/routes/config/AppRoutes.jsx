			...
			<Routes>
				...
				<Route element={<AdminRoute />}>
					...
					<Route
						...
						element={<AdminManageSessions />}
					/>
					<Route
						path="/admin/manage-languages"
						element={<AdminManageLanguages />}
					/>
					<Route
						path="/admin/verify-tutor/:userId"
						element={<AdminVerifyTutor />}
					/>
					<Route
						path="/admin/verify-language/:requestId"
						element={<AdminVerifyLanguage />}
					/>
					<Route
				...
				<Route element={<TutorRoute />}>
					...
					<Route
						path="/tutor/teaching-languages"
						element={<TutorTeachingLanguages />}
					/>
				...
				<Route element={<PublicRoute />}>
					...
					<Route
						path="/tutor/request/application-confirmation"
						element={<TutorRequestApplicationConfirmation />}
					/>
