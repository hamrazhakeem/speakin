...
urlpatterns = [
    ...
    path("tutor/verify-email/", TutorVerifyEmailView.as_view()),
    path("tutor/verify-otp/", TutorVerifyOtpView.as_view()),
    ...
    path(
        ...
        TeachingLanguageChangeRequestView.as_view(),
    ),
    path(
        "teaching-language-change-requests/<int:pk>/",
        TeachingLanguageChangeRequestView.as_view(),
    ),
